...
<script>
import NotificationDropdown from "@/Components/AdminDashboard/Dropdowns/NotificationDropdown.vue";
import UserDropdown from "@/Components/AdminDashboard/Dropdowns/UserDropdown.vue";
